...
def invoice_config(request):
    ...
    if request.method == "GET":
        ...
        data = {
            ...
            "cgst_rate": getattr(config, "cgst_rate", 9.0),
            "sgst_rate": getattr(config, "sgst_rate", 9.0),
            "home_state": getattr(config, "home_state", "Telangana"),
            "gst_enabled_countries": getattr(config, "gst_enabled_countries", ["India"]),
