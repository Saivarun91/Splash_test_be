...
class PaymentTransaction(Document):
    ...
    billing_organization_name = StringField()
    billing_country = StringField()
    billing_address_line1 = StringField()
    billing_address_line2 = StringField()
    billing_city = StringField()
    billing_pin = StringField()
    billing_state = StringField()
    plan_slug = StringField()
    cgst_rate = FloatField()
    sgst_rate = FloatField()
